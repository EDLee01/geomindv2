...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-geo-primary-900 to-geo-primary-800 flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <h2 className="text-2xl font-semibold text-geo-primary-800 mb-6 text-center">Welcome Back</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 px-4 bg-geo-accent hover:bg-geo-accent-600 text-white font-medium rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
          ...
          <div className="mt-6 text-center">
            <p className="text-geo-primary-600">
              ...
              <Link href="/register" className="text-geo-accent hover:text-geo-accent-600 font-medium">
                Sign up
              </Link>
            </p>
          </div>
